...
public class TemplateGuesser {
    ...
    public static void adjustWordAndSentencePathsBasedOnMode(HashMap<String, String> columnPaths, String sentencePath, String wordPath, HashMap<String, Integer> pathFrequencies, SubtreeGuessMode mode) {
        System.out.println(columnPaths);
...
//            System.out.println(pathSuffixFromWordPathDownwards);
        ...
        adjustWordAndSentencePathsBasedOnMode(templateColumns, sentencePath, wordPath, pathFrequencies, SubtreeGuessMode.largest);
